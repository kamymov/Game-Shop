...
<body>
        ...
        <a href="XbGame.php" style="color: darkgreen;" class="a_menu_responsive">ایکس باکس<i class="fa fa-angle-left" style="font-size:20px;margin-right:9px;color: white;"></i></a>
                    ...
                    if($count > 0){
                        ...
                        echo '
                            ...
                            <div style="cursor:pointer;background-color:#747474;width:175px;margin: 10px auto;border-radius:20px;padding: 2.5px 10px;">
                                ...
                                <h2 style="color:white;border-radius:10px;">ثبت خرید و پرداخت</h2>
...
<div class="div_form_login">
    ...
    <form action="LoginRegister.php" method="POST">
        ...
        <div class="div_bazi_list" id="div_bazi_pc">
            ...
            <div class="div_menu_hover"  id="div_menu_hover_pc" style="background-color:rgb(108, 13, 148,0.9);border-radius: 0px 0px 10px 10px">
            ...
            <a href="XbGame.php" style="color: darkgreen;" class="a_menu" id="a_bazi_xb">ایکس باکس<i class="fa fa-angle-down" style="font-size:20px;margin-right:9px;"></i></a>
            ...
            <script>
                  ...
                  function FilterZhanr(Zhanr){
                    ...
                    if(Zhanr == ""){
                        ...
                        xmlhttp.open("GET","DeleteFilter.php?plt=" + Zhanr + "&pt=Xbox",true);
                        xmlhttp.send();
                        ...
                        xmlhttp.open("GET" , "Filter.php?rq=" + Zhanr + "&tr=zhanr_mahsol&tb=Xbox", true);
                        xmlhttp.send();
                    }
            ...
            <script>
                  ...
                  function FilterStudio(Zhanr){
                    ...
                    if(Zhanr == ""){
                        ...
                        xmlhttp.open("GET" , "Filter.php?rq=" + Zhanr + "&tr=sazande_bazi_mahsol&tb=Xbox", true);
                        xmlhttp.send();
                    }
        ...
        <script>
            ...
            function FilterPelatform(plt){
                ...
                if(plt == ""){
                    ...
                    xmlhttp.open("GET","DeleteFilter.php?plt=" + plt + "&pt=Xbox",true);
                    xmlhttp.send();
                    ...
                    xmlhttp.open("GET" , "Filter.php?rq=" + plt + "&tr=online_mahsol&tb=Xbox", true);
                    xmlhttp.send();
                }
    ...
    <script>
        ...
        <div class="div_producs_koli">
            ...
            <div class="div_logo_producs">
                ...
                <h3 class="h1_producs_title" style="color: darkgreen;">بازی های ایکس باکس</h3>

                <i class="fab fa-xbox" style="color:green;font-size:20px"></i>
...
<?php
        ...
        if(isset($_GET['Zhanr'])){
            ...
            $select_pc_mahsolat = "SELECT * FROM mahsol__pc WHERE zhanr_mahsol='" . $_GET['Zhanr'] . "' AND pelatform_mahsol='Xbox' LIMIT 20";
            ...
            $select_pc_mahsolat = "SELECT * FROM mahsol__pc WHERE price_mahsol<='$Price_value' AND pelatform_mahsol='Xbox'";
            ...
            $select_pc_mahsolat = "SELECT * FROM mahsol__pc WHERE pelatform_mahsol='Xbox'  LIMIT 20";
