...
<body>
    ...
    <div class="body">
        ...
        <a href="PcGame.html" style="color: rgb(108, 33, 148);" class="a_menu_responsive">بازی های Pc<i class="fa fa-angle-left" style="font-size:20px;margin-right:9px;color: white;"></i></a>
        <a href="XbGame.html" class="a_menu_responsive">ایکس باکس<i class="fa fa-angle-left" style="font-size:20px;margin-right:9px;color: white;"></i></a>
        <a href="PsGame.html" class="a_menu_responsive">پلی استیشن<i class="fa fa-angle-left" style="font-size:20px;margin-right:9px;color: white;"></i></a>
...
<div class="div_form_login">
    ...
    <form action="LoginRegister.php" method="POST">
        ...
        <input type="search" name="" placeholder="جستجو..." id="input_search">
...
<div class="div_bazi_list" id="div_bazi_pc">
    ...
    <a href="PcGame.php" id="a_bazi_pc" style="color:rgb(108, 13, 148)" class="a_menu">کامپیوتر<i class="fa fa-angle-down" style="font-size:20px;margin-right:9px;"></i></a>
        ...
        <div class="div_body_pxs">
                            ...
                            <script>
                                  ...
                                  function FilterZhanr(Zhanr){
                                    ...
                                    if(Zhanr == ""){
                                        ...
                                        xmlhttp.open("GET","DeleteFilter.php?plt=" + Zhanr + "&pt=PC",true);
                                        xmlhttp.send();
                                        ...
                                        xmlhttp.open("GET" , "Filter.php?rq=" + Zhanr + "&tr=zhanr_mahsol&tb=PC", true);
                                        xmlhttp.send();
                                    }
                            ...
                            <script>
                                  ...
                                  function FilterStudio(Zhanr){
                                    ...
                                    if(Zhanr == ""){
                                        ...
                                        xmlhttp.open("GET" , "Filter.php?rq=" + Zhanr + "&tr=sazande_bazi_mahsol&tb=PC", true);
                                        xmlhttp.send();
                                    }
                        ...
                        <script>
                            ...
                            function FilterPelatform(plt){
                                ...
                                if(plt == ""){
                                    ...
                                    xmlhttp.open("GET","DeleteFilter.php?plt=" + plt + "&pt=PC",true);
                                    xmlhttp.send();
                                    ...
                                    xmlhttp.open("GET" , "Filter.php?rq=" + plt + "&tr=online_mahsol&tb=PC", true);
                                    xmlhttp.send();
                                }
            ...
            <div class="div_producs_koli">
                ...
                <div class="div_logo_producs">
                    ...
                    <h2 class="h1_producs_title" style="color: black(108, 33, 148);">بازی های کامپیوتر</h2>

                    <img src="Logo img/PC.jfif" class="img_logo_producs" alt="">
                ...
                <div  id='div_pc' class="div_producs">                                                    
                    ...
                    <?php
                            ...
                            if(isset($_GET['Zhanr'])){
                                ...
                                $select_pc_mahsolat = "SELECT * FROM mahsol__pc WHERE zhanr_mahsol='" . $_GET['Zhanr'] . "' AND pelatform_mahsol='PC' LIMIT 20";
                                ...
                                $select_pc_mahsolat = "SELECT * FROM mahsol__pc WHERE price_mahsol<='$Price_value' AND pelatform_mahsol='PC'";
                                ...
                                $select_pc_mahsolat = "SELECT * FROM mahsol__pc WHERE pelatform_mahsol='PC'  LIMIT 20";
